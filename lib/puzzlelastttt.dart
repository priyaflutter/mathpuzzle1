...
class puzzlelasttt1 extends StatefulWidget {


  @override
  State<puzzlelasttt1> createState() => _puzzlelasttt1State();
}

class _puzzlelasttt1State extends State<puzzlelasttt1> {
  @override
                  ...
                  if (levelstatus == "clear") {
                    return InkWell(onTap: () {
                      ...
                      child: Container(
                        ...
                        child: Center(child: Text("${index + 73}",
                          style: TextStyle(
